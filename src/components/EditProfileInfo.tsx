import { Box, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, IconButton, Input, InputAdornment, TextField, Typography } from "@mui/material";
...
const defaultUser : User = {
    id : 0 , email : "" , firstName : "" , lastName : "" , bio : "" , day : 1 , month : 1 , year : 2000
}
